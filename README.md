...
- **Discord Bot 連携** — Discord に画像を投稿すると動画が返ってくる Bot をアプリ内から設定・起動できます
...
makeAiFactory が起動している PC を「動画生成サーバー」として使い、Discord の仲間が画像を送ると動画が返ってくる Bot を設定できます。
...
- makeAiFactory のアプリ画面でも生成中の画像がリアルタイム表示されます
- **問題のある画像は「中断」ボタン**でその場でキャンセルできます
